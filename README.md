...
```bash
# Download script
wget https://raw.githubusercontent.com/izalxy/web2apk/main/scripts/setup-vps.sh
...
```bash
git clone https://github.com/izalxy/web2apk.git
cd web2apk
npm install
cp .env.example .env
...
sudo ufw allow 3201    # Dashboard (jika TIDAK pakai Nginx)
sudo ufw enable
```
